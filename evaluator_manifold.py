''' evaluation function to score candidate sequence '''

import common_utils.get_msat_output as get_msat_output
...
class EmbeddingEvaluator:
    ...
    def scorer_manifold(candidate_sequence, context_msa_file):
        ...
        = get_msat_output.get_current_state_with_ll(candidate_sequence, context_msa_file)
